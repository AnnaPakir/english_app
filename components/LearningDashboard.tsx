...
import { LearningTask, UserData, TaskType, TaskEvaluation, CEFRLevel } from '../types.ts';
...
const LearningDashboard: React.FC<LearningDashboardProps> = ({ geminiService, userData, onUserDataChange, onTaskComplete, onStartLevelUpTest, onFeedbackSubmit }) => {
    ...
    const level: CEFRLevel = userData.level!;
    ...
    }, [level, userData.feedbackHistory, geminiService]);
