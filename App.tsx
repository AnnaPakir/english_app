...
const App: React.FC = () => {
        ...
        try {
            ...
            if (savedDataRaw) {
                ...
                if (savedData.apiKey) {
                    ...
                    if (!savedData.imageGeneration || savedData.imageGeneration.date !== today) {
                        savedData.imageGeneration = { count: 0, date: today };
                    }
    ...
    const handleStartAssessment = useCallback(async () => {
        if (!geminiService) {
            setError("Сервис не инициализирован. Пожалуйста, войдите снова.");
            setAppState(AppState.AUTH);
            return;
        }
    ...
    const renderContent = () => {
        ...
        switch (appState) {
            ...
            default:
                setAppState(AppState.AUTH) // Fallback
                return null;
        }
    };
