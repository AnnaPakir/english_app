...
import { AppState, CEFRLevel, AssessmentQuestion, UserData } from './types';
...
import { CEFR_LEVELS_ORDER, LEVEL_UP_PASS_PERCENTAGE, PROGRESS_HISTORY_LENGTH } from './constants';
import LevelUpAssessment from './components/LevelUpAssessment';
import LevelUpResultsScreen from './components/LevelUpResultsScreen';
