    ...
    const renderMainContent = () => {
        switch (appState) {
            case AppState.WELCOME:
                return <WelcomeScreen user={userData.user} onStart={handleStartAssessment} />;
            ...
            case AppState.RESULTS:
                ...
                return <ResultsScreen level={userData.level} onStartLearning={() => setAppState(AppState.LEARNING)} />;
            
            case AppState.LEARNING:
                if (!userData.level || !geminiService) {
                    setAppState(AppState.WELCOME);
                    return null;
                }
                return <LearningDashboard geminiService={geminiService} userData={userData} onUserDataChange={handleUserDataChange} onTaskComplete={handleTaskComplete} onStartLevelUpTest={handleStartLevelUpTest} onFeedbackSubmit={handleFeedbackSubmit} />;
