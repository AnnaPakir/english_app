...
class GoogleDriveService {
    ...
    private async createFile(): Promise<string> {
        ...
        const res = await fetch(`${this.DRIVE_UPLOAD_URL}/files?uploadType=media`, {
            method: 'POST',
            headers: this.getHeaders(),
            body: JSON.stringify(metadata) // This is incorrect, let's fix it.
        });
        
        // Correct way to create a file with initial content
        ...
        if (!createRes.ok) throw new Error('Failed to create file in Google Drive.');
